            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2>Search: <?php echo $data['key']; ?></h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img src="<?php echo constant('path'); ?>public/image/product/<?php echo $data['listpd'][$i]['image']; ?>" alt="">
                        </div>
                        ...
                        <div class="product-option-shop">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="<?php echo constant('path'); ?>Customer/addCart/<?php echo $data['listpd'][$i]['id']; ?>">Add to cart</a>
                        </div>                       
                    </div>
                </div>
                <?php } ?>
                        ...
                        <nav>
                          <ul class="pagination">
                            <?php 
                                ...
                                $urlNext = constant("path").'Cutomer/Search/'.$key.'/'.$next;
                                $urlPre = constant("path").'Cutomer/Search/'.$key.'/'.$pre;
